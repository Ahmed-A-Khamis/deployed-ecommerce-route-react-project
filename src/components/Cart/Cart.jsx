				...
				<div className="relative overflow-x-auto shadow-md sm:rounded-lg">
					{cart.length > 0 ? (
						<>
							...
							<button
								onClick={() => navigateTo(`/checkout/${cartId}`)}
								type="submit"
								className="text-white w-full my-4 mx-auto duration-300 bg-green-500 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm  px-5 py-2.5 text-center "
							>
								Check Out
							</button>
						</>
